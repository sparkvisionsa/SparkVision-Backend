...
const word_template_merge_service_1 = require("./word-template-merge.service");
...
let MachineValuationController = class MachineValuationController {
    constructor(mvService, fileParser, mvRealtime, wordTemplateMerge) {
        this.mvService = mvService;
        this.fileParser = fileParser;
        this.mvRealtime = mvRealtime;
        this.wordTemplateMerge = wordTemplateMerge;
    }
    ...
    async listSystemInspectors(req, res, id) {
        const context = await (0, context_1.resolveRequestContext)(req);
        (0, context_1.applyContextCookies)(res, context);
    ...
    async listSubProjectDetails(req, res, projectId, idsRaw) {
        const context = await (0, context_1.resolveRequestContext)(req);
        (0, context_1.applyContextCookies)(res, context);
        const ids = String(idsRaw ?? "")
            ...
            .filter(Boolean);
        if (ids.length > 50)
            throw new common_1.BadRequestException("الحد الأقصى للدفعة 50 مجلدًا.");
        if (ids.some((id) => !/^[a-f0-9]{24}$/i.test(id))) {
            throw new common_1.BadRequestException("تحتوي الدفعة على معرف مجلد غير صالح.");
        }
    ...
    async listProjectAssetImageFiles(req, res, projectId, cursor, limitRaw) {
        const context = await (0, context_1.resolveRequestContext)(req);
        (0, context_1.applyContextCookies)(res, context);
    ...
    async downloadProjectAssetImageFiles(req, projectId, downloadId, res) {
        const context = await (0, context_1.resolveRequestContext)(req);
        (0, context_1.applyContextCookies)(res, context);
        const download = await this.mvService.getProjectAssetImagesZip(projectId, toMvAccess(context), downloadId);
    ...
    async getProjectAssetImageDownloadProgress(req, res, projectId, downloadId) {
        const context = await (0, context_1.resolveRequestContext)(req);
        (0, context_1.applyContextCookies)(res, context);
        res.setHeader("Cache-Control", "no-store");
        return this.mvService.getAssetImagesDownloadProgress(projectId, downloadId, toMvAccess(context));
    }
    ...
    async mergeWordTemplate(req, res, projectId, body) {
        const context = await (0, context_1.resolveRequestContext)(req);
        (0, context_1.applyContextCookies)(res, context);
...
__decorate([
    (0, common_1.Get)("projects/:id/system-inspectors"),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)({ passthrough: true })),
    __param(2, (0, common_1.Param)("id")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, String]),
    __metadata("design:returntype", Promise)
], MachineValuationController.prototype, "listSystemInspectors", null);
__decorate([
...
__decorate([
    (0, common_1.Get)("projects/:pid/subproject-details"),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)({ passthrough: true })),
    ...
    __metadata("design:paramtypes", [Object, Object, String, String]),
    __metadata("design:returntype", Promise)
], MachineValuationController.prototype, "listSubProjectDetails", null);
__decorate([
...
__decorate([
    (0, common_1.Get)("projects/:pid/asset-image-files/download"),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)("pid")),
    __param(2, (0, common_1.Query)("downloadId")),
    __param(3, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, Object, Object]),
    __metadata("design:returntype", Promise)
], MachineValuationController.prototype, "downloadProjectAssetImageFiles", null);
__decorate([
    (0, common_1.Get)("projects/:pid/asset-image-files/download-progress/:downloadId"),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)({ passthrough: true })),
    __param(2, (0, common_1.Param)("pid")),
    __param(3, (0, common_1.Param)("downloadId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, String, String]),
    __metadata("design:returntype", Promise)
], MachineValuationController.prototype, "getProjectAssetImageDownloadProgress", null);
__decorate([
...
__decorate([
    (0, common_1.Post)("projects/:pid/word-template/merge"),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)()),
    __param(2, (0, common_1.Param)("pid")),
    __param(3, (0, common_1.Body)()),
...
exports.MachineValuationController = MachineValuationController = __decorate([
    ...
    __metadata("design:paramtypes", [machine_valuation_service_1.MachineValuationService,
        ...
        word_template_merge_service_1.WordTemplateMergeService])
