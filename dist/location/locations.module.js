...
exports.LocationsModule = LocationsModule = __decorate([
    (0, common_1.Module)({
        controllers: [
            locations_controller_1.RegionsController,
            locations_controller_1.CitiesController,
            locations_controller_1.NeighborhoodsController,
            locations_controller_1.LocationsSeedController,
        ],
