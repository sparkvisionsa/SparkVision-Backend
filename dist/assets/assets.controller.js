    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)("file", {
        ...
        fileFilter: (_, file, callback) => {
            if (!(0, asset_import_service_1.isAssetImportMultipartAllowed)(file.mimetype, file.originalname || "")) {
                callback(new common_1.BadRequestException("نوع الملف أو الامتداد غير مدعوم. استخدم XLSX أو XLS أو CSV. إذا كان الامتداد صحيحاً وما زال يرفض، جرّب متصفحاً آخر أو أعد تسمية الملف بالإنجليزية."), false);
                return;
            }
            callback(null, true);
        },
