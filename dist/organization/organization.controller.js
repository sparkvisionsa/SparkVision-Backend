...
let OrganizationController = class OrganizationController {
    ...
    async companyAdminReportDefaults(req, res) {
        const result = await (0, service_1.getCompanyReportDefaultsForCompanyAdmin)(req);
        (0, context_1.applyContextCookies)(res, result.context);
        return result.payload;
    }
    async patchCompanyReportDefaults(req, res, body) {
        const result = await (0, service_1.updateCompanyReportDefaultsByCompanyAdmin)(req, body);
        (0, context_1.applyContextCookies)(res, result.context);
        return result.payload;
    }
...
__decorate([
    (0, common_1.Get)("company/admin/report-defaults"),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)({ passthrough: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OrganizationController.prototype, "companyAdminReportDefaults", null);
__decorate([
    (0, common_1.Patch)("company/admin/report-defaults"),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)({ passthrough: true })),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", Promise)
], OrganizationController.prototype, "patchCompanyReportDefaults", null);
__decorate([
